...
import 'package:project_work/Diary/Classes/note.dart';
import 'package:project_work/Diary/Utils/db_halper.dart';
...
class _AddNoteState extends State<AddNote> {
  ...
  bool _checkNotNull() {
    ...
    if (_titleControllor.text.isEmpty && _noteControllor.text.isEmpty) {
      _showSnakbar('Title and Tell me something cannot be empty');
      res = false;
    } else if (_noteControllor.text.isEmpty) {
      _showSnakbar('Tell me something cannot be empty');
      res = false;
          ...
          children: <Widget>[
            ...
            TextField(
              ...
              decoration: InputDecoration(
                  ...
                  hintText: 'Hi, tell me about your day ❤'),
            ),
            SizedBox(
              height: 20,
            ),
