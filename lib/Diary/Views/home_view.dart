...
import 'package:project_work/Diary/Utils/theme_bloc.dart';
import 'package:project_work/Diary/Views/add_note_view.dart';
                ...
                builder: (BuildContext context, AsyncSnapshot snapshot) {
                  if (snapshot.data == null) {
                    ...
                    if (snapshot.data.length < 1) {
                      return Center(
                        child: Text(
                            'No Entry, Tell me how you are feeling today 😊'),
                      );
                    }
